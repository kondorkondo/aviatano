...
// ZenoPay API Routes (public for webhook)
Route::prefix('api/zenopay')->group(function () {
    Route::post('/webhook', [ZenoPayController::class, 'webhook']);
    Route::get('/check-status', [ZenoPayController::class, 'checkStatus']);
    Route::post('/test-order', [ZenoPayController::class, 'createTestOrder']);
});
