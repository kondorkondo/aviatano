...
<body class="dark-bg-main">
                                    ...
                                    <div class="list-items">
                                        ...
                                        <div class="column-2">
                                            <button
                                                ...
                                                {{ number_format($item->amount, 2) }}TSh
                                            </button>
                                        </div>
                                        <div class="column-3">
                                        ...
                                        <div class="column-4 fw-normal">
                                            {{ number_format($item->amount * $item->cashout_multiplier, 2) }}TSh
                                        </div>
                                    </div>
                                @endforeach
                                    ...
                                    <div class="bets-opt-list">
                                        <button class="btn btn-secondary btn-sm bet-opt main_amount_btn"
                                            onclick="select_direct_bet_amount(this);"><span
                                                class="amt">100</span><span class="currency">TSh</span></button>
                                        <button class="btn btn-secondary btn-sm bet-opt main_amount_btn"
                                            onclick="select_direct_bet_amount(this);"><span
                                                class="amt">200</span><span class="currency">TSh</span></button>
                                        <button class="btn btn-secondary btn-sm bet-opt main_amount_btn"
                                            onclick="select_direct_bet_amount(this);"><span
                                                class="amt">500</span><span class="currency">TSh</span></button>
                                        <button class="btn btn-secondary btn-sm bet-opt main_amount_btn"
                                            onclick="select_direct_bet_amount(this);"><span
                                                class="amt">1000</span><span class="currency">TSh</span></button>
                                    </div>
                                </div>
                ...
                <div class="modal-body">
                    <ul class="list-unstyled limit-rules">
                        <li class="list-group-item">
                            Minimum Bet:
                            <span class="badge badge-success px-2 font-family-number">10 TSh </span>
                        </li>
                        <li class="list-group-item">
                            Maximum Bet:
                            <span class="badge badge-success px-2 font-family-number">8000 TSh </span>
                        </li>
                        <li class="list-group-item">
                            Maximum win for one bet:
                            <span class="badge badge-success px-2 font-family-number">800000 TSh </span>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <script>
        ...
        var currency_symbol = 'TShs'; // or get this from your backend properly
