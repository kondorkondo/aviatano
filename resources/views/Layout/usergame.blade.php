...
<head>
    ...
    <!--====== Title ======-->
    <title>Aviatano the main AVIATOR of all {{env('APP_NAME')}} - online  betting</title>
                                ...
                                <form class="register-form row" action="http://52.71.176.55:8082/register_post"
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="input-group mb-3">
                                            <div class="niceCountryInputSelector" data-selectedcountry="TZ"
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="input-group flex-nowrap mb-3">
                                            ...
                                            <select class="form-select custom-select" id="inputGroupSelect01"
                                                name="currency">
                                                <option selected value="TSh">TSh</option>
